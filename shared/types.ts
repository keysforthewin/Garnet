...
export interface Settings { idleMs: number; maxSaveMs: number; trashDays: number; revisionLimit: number; agent: { provider: 'claude' | 'codex'; claudePath: string; codexPath: string; claudeModel: string; codexModel: string; cwd: string; timeoutMinutes: number } }
export const defaults: Settings = { idleMs: 750, maxSaveMs: 5000, trashDays: 30, revisionLimit: 100, agent: { provider: 'claude', claudePath: 'claude', codexPath: 'codex', claudeModel: '', codexModel: '', cwd: '', timeoutMinutes: 30 } };
