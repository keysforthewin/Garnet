...
4. Keep `data/documents` and `data/runtime`. The application no longer uses a local certificate authority or HTTPS listener. Preserve old certificate files with your backup if you need rollback; do not move them into the new application setup.
